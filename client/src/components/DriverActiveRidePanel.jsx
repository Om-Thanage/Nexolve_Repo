...
import { Phone, MessageSquare, Shield, CheckCircle2, Navigation as NavIcon, Car, Users, X } from 'lucide-react';
import api from '../api';

export default function DriverActiveRidePanel({ trip, requests, onReset, onDriverArrived }) {
    ...
    const activeRequests = requests.filter(r => ['accepted', 'arrived', 'ongoing'].includes(r.status));
                    ...
                    <div className="pt-4 border-t border-border">
                        ...
                        <div className="space-y-2 opacity-60">
                            {completedRequests.map(req => (
                                <div key={req._id} className="flex items-center justify-between text-sm p-2 bg-secondary/20 rounded-lg">
